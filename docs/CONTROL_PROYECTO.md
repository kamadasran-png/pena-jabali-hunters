...
Dentro de esta ubicación se encuentran los documentos originales incorporados.
...
- Total de documentos inventariados: 46.
- PDF incorporados: 46.
- PDF pendientes: 0.
- Nombres originales: conservados.
- Rutas reales: registradas en `INVENTARIO_PLANOS_ANTONINO.md`.
- Inventario: actualizado a 46/46.
- Material primario: conservado íntegramente.

El archivo histórico primario no se modifica para crear material derivado.

El documento de inventario correspondiente es:
...
Todo archivo recuperado deberá ser identificado, revisado, clasificado y aprobado antes de incorporarse.
...
Todos los elementos del archivo histórico primario podrán, previa decisión y tratamiento correspondiente, pasar a:

- material derivado;
- material reeditado;
- contenidos documentales;
- contenidos para la web pública;
- otros formatos que se determinen durante el desarrollo.

No se establece en esta fase una exclusión previa de documentos por su antigüedad, contenido o formato.
