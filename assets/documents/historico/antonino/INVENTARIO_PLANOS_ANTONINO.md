...
Este inventario comprende los **46 planos/documentos históricos definitivos** del archivo `PLANOS ANTONINO BATIDAS ALMANSA`.

Los 46 documentos han sido validados por el responsable del archivo, que confirma la autenticidad y realidad histórica de su contenido y señala que muchos fueron dibujados personalmente por él.

Los originales se conservarán íntegros. No se eliminarán documentos por aparentes duplicados o por diferencias de nombre, año o versión.

**Importante:** este índice no implica todavía la publicación de los documentos en la web. La incorporación de los PDF originales se realizará posteriormente y de forma controlada.
...
- [ ] Incorporación de los 46 PDF originales
...
Los PDF originales constituyen el **archivo histórico primario**.

Cualquier imagen, ficha, texto o versión preparada para la web será material derivado y no sustituirá al documento original.
